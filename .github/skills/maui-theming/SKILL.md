...
description: >
  ...
  accessibility-only visual adjustments, or app icon and splash asset work.
---
...
```xml
<!-- Updates when the theme dictionary changes -->
<Label TextColor="{DynamicResource PrimaryTextColor}" />

<!-- Frozen at first load and will not update on theme switch -->
