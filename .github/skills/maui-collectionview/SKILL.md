...
description: >
  ...
  DO NOT USE FOR: static, non-data-driven layouts,
  map-specific UI, or table-style data entry forms.
---
...
Do not use a `StackLayout`-based items layout here. It has no virtualization and can trigger repeated threshold events. Use `LinearItemsLayout` or `GridItemsLayout` instead.
